...
- MUST NOT write anything into `agent-execution/{task_name}/document/`.
...
- If plan file is:
  `.agent-execution/{task_name}/document/{plan_file}.md`
- Then log file MUST be:
  `.agent-execution/{task_name}/log/execution__{plan_file}.md`
